...
class MultiLayerConv1d(nn.Module):
    ...
    Attributes:
        ...
        dropout_first (Sequence[bool]): Whether to perform dropout before the convolutional layer.
    ...
    def __init__(self,
                 ...
                 dropout_first: bool | Sequence[bool] = False) -> None:
        """
        ...
        Args:
            ...
            dropout_first (bool | Sequence[bool], optional): Whether to perform dropout before the convolutional layer, default is False.
        ...
        Raises:
            ...
            AssertionError: If dropout_p, dropout_inplace, dropout_first does not have length num_layers - 1.
        """
